...
export const TrainingFormCore = forwardRef<FormHandle, FormProps<TrainingValues>>(function TrainingFormCore(
  ...
  return (
    <View className="flex-1 gap-4">
      {slots.map((tr, index) => {
        ...
        const variant: 'completed' | 'default' | 'disabled' = isCompleted ? 'completed' : isDisabled ? 'disabled' : 'default'
        return (
          <TrainingCard
