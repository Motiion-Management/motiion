...
export const GenderFormCore = forwardRef<FormHandle, FormProps<GenderValues>>(function GenderFormCore(
  ...
  return (
    <ValidationModeForm form={form}>
      <form.AppField name="gender" children={(field: any) => <field.RadioGroupField options={options} />} />
    </ValidationModeForm>
  )
})
