...
export function GestureTutorial({
  ...
  return (
    <Animated.View
      style={animatedStyle}
      className={`absolute bottom-20 left-0 right-0 z-20 items-center ${className}`}>
      <View className="rounded-full border border-border-default bg-surface-default/95 px-6 py-3 shadow-lg backdrop-blur-sm">
        <View className="flex-row items-center gap-4">
          ...
          <Text variant="footnote" className="text-center text-text-default">
            {message}
          </Text>
