              ...
              <Animated.View
                ...
                <DropdownMenuPrimitive.Content
                  ...
                  <Animated.View
                    ...
                    className="z-50 rounded-md border border-border/20 bg-card py-2 shadow-xl">
...
function DropdownMenuLabel(props: { children: React.ReactNode }) {
  return (
    <DropdownMenuPrimitive.Label className="border-b border-border/25 px-3 pb-2 text-sm text-muted-foreground/80 dark:border-border/80 dark:text-muted-foreground">
      {props.children}
